...
class Main extends PluginBase implements Listener {
    ...
    public function onLoad(){
        ...
        $this->config->getAll();
        $this->getLogger()->info("§ePing §eis loading...");
    }
    public function onEnable(){
        $this->getServer()->getPluginManager()->registerEvents($this, $this);
        $this->getLogger()->info("§6Ping§a has been enabled!");
    }
    public function onDisable(){
        $this->getLogger()->info("§6Ping§c has been disabled!");
    }
            ...
            case'ping':
                if(!isset($args[0])){
                    ...
                    if($args[0] == "help" || $args[0] == null){
                        ...
                        $sender->sendMessage("§e/pinginfo - Shows info");
                        ...
                        if($target instanceof Player) {
                            if($sender->hasPermission("ping.ping.others")){
